...
try:
    ...
    print 'Trying to install urllib2 module'
    os.sytem('pip install urllib2')
    import urllib2
import getopt
import json
try:
    ...
    print 'Trying to install geolocation'
    os.system('pip install geolocation')
    from geolocation.main import GoogleMaps as googlemaps


gmaps = googlemaps(api_key="AIzaSyB7janFYkqPTcNDYU7jy8kTVcjDdasuG8I")
